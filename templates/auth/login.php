                ...
                <div class="w-full">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#" method="POST">
                            ...
                            <button type="submit" class="w-full text-black bg-white border border-black hover:bg-[#58463E] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Connexion</button>
