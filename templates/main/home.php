...
<div class="m-10 space-y-4">
    ...
    <div class="flex flex-col md:flex-row items-center justify-center">
        <img class=" max-w-lg md:w-1/2 rounded-lg object-cover md:mr-8" src="img/connectedPoster.jpg" alt="
        Image">
        <div class="w-full md:w-1/2 mt-6 md:mt-0 text-center p-6">
    ...
    <div class="flex flex-col md:flex-row items-center justify-center">
       <div class="w-full md:w-1/2 mt-6 md:mt-0 text-center p-6">
        ...
        <img class="max-w-lg md:w-1/2 rounded-lg object-cover md:mr-8" src="img/connectedPoster1.jpg" alt="Image">
    </div>

    <div class="flex flex-col md:flex-row items-center justify-center">
        <img class="max-w-lg md:w-1/2 rounded-lg object-cover md:mr-8" src="img/connectedPoster2.jpg" alt="Image">
        <div class="w-full md:w-1/2 mt-6 p-6 md:mt-0 text-center">
